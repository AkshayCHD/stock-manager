...
//     it("Validate average price for buy and sell transactions", async () => {
//       let result = await chai
//         .request(app)
//         .post(`/api/transaction/buy/${security.ticker}`)
//         .set("content-type", "application/json")
...
//       assert.equal(holding?.averagePrice, 1000);
//       assert.equal(holding?.totalReturns, -2500);
//     });
...
//       assert.equal(holding?.totalReturns, 0);
...
//       assert.equal(holding?.shareCount, 30);
//     });
...
//       assert.equal(holding?.totalReturns, 1250);
//       assert.equal(holding?.averagePrice.toFixed(6), (1000).toFixed(6));
//       assert.equal(holding?.shareCount, 5);
//     });
//   });
